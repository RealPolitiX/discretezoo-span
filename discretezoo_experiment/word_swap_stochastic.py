...
class WordSwapEmbeddingStochastic(WordSwap):
  ...
  def __init__(self,
    ...
    self.neighbordhood_size = neighborhood_size
  ...
  def _get_replacement_words(self, word):
    ...
    try:
      ...
      nnids = self.embedding.nearest_neighbours(word_id,
                                                self.neighbordhood_size)
      nnids = random.sample(nnids.tolist(), self.max_candidates)
      candidate_words = []
